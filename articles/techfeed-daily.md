---
title: "【毎日更新】海外テックニュース日本語まとめ｜最終更新 2026/06/19"
emoji: "📰"
type: "tech"
...
### 2. レジリアントな決済システム向けセルベース アーキテクチャ
...
### 3. 韓国通信大手SKテレコムとAnthropicの輸出規制問題
...
### 5. TerraPower、Meta向けに小型原子炉8基を供給する大型契約
...
### 6. Elasticsearchで構築した永続的エージェントメモリ層
...
### 8. AMD、消費者向けRyzen CPUからメモリ暗号化を静かに削除
...
### 9. SLSA超越：ゼロクリックCI/CDワーム対策9ステップ計画
...
### 10. 強制的同意は違法：Elkjöp社が€1.8M罰金を科される
**重要度: 62/10** | タグ: `GDPR`, `プライバシー`, `コンプライアンス`, `UXデザイン`, `同意取得`

ノルウェーの大手家電量販店Elkjöp社が、ユーザーに対して不当な同意メカニズムを強制していた事案について、5年後に€1.8M（約2.5億円）の罰金を科されました。技術的背景として、GDPR等の規制では「真の同意」が必須であり、同意取得時にユーザーが拒否する選択肢を同等に提供する必要があります。本件は同社がサービス利用時に同意を強制し、実質的に拒否不可能な状態を作出していたことが違反となりました。同種違反は欧州全域で多数指摘されており、Web設計やUX実装において法令遵守の重要性が高まっています。

🔗 [原文を読む](https://www.thatprivacyguy.com/blog/elkjop-forced-consent-fine/)
